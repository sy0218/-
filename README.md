...
| 📷 **다중 서버 모니터링** | Node Exporter · Prometheus · Grafana 기반 통합 모니터링 구성 | **[`📘 매뉴얼 보기`](./docs/prometheus_grafana_setup.md)** |
...
| 🔍 **Elasticsearch** | 검색엔진 클러스터 설치/설정 | **[`📘 매뉴얼 보기`](./docs/elasticsearch_setup.md)** |
