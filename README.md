...
| 📷 **다중 서버 모니터링** | Node Exporter · Prometheus · Grafana 기반 통합 모니터링 구성 | **[`📘 매뉴얼`](./docs/prometheus_grafana_setup.md)** |
...
| 🐘 **Hadoop** | 분산 시스템 클러스터 설치/설정 | **[`📘 매뉴얼`](./job_all_md/hadoop_manual.md)** |
